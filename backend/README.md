...
## Project Structure
    ...
    ├── ideapros_llc_worldt_30844  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_worldt_30844`
...
2. Clone this repo and `cd ideapros_llc_worldt_30844`
